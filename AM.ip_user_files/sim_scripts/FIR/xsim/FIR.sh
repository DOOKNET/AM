...
#
# Generated by Vivado on Thu Jan 25 20:07:52 +0800 2018
...
# Script info
echo -e "FIR.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L axi_utils_v2_0_3 -L fir_compiler_v7_2_7 -L xil_defaultlib -L secureip -L xpm --snapshot FIR xil_defaultlib.FIR -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim FIR -key {Behavioral:sim_1:Functional:FIR} -tclbatch cmd.tcl -log simulate.log
}
