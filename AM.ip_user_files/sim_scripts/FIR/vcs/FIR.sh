...
# Design libraries
design_libs=(xil_defaultlib xpm xbip_utils_v3_0_7 axi_utils_v2_0_3 fir_compiler_v7_2_7)
...
compile()
{
  ...
  vhdlan -work fir_compiler_v7_2_7 $vhdlan_opts \
    "$ref_dir/../../../ipstatic/hdl/fir_compiler_v7_2_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../Design/IP_Core/FIR/FIR/sim/FIR.vhd" \
  2>&1 | tee -a vhdlan.log
