...
#
# Generated by Vivado on Sat Jan 20 12:43:07 +0800 2018
...
# Script info
echo -e "MULT.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot MULT xil_defaultlib.MULT -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim MULT -key {Behavioral:sim_1:Functional:MULT} -tclbatch cmd.tcl -log simulate.log
}
